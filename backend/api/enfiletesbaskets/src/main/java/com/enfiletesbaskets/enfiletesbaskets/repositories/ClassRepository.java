...
public interface ClassRepository extends JpaRepository<ClassModel, Integer> {
    ...
    List<ClassModel> findSubscribedClassesByUserId(@Param("userId") Integer userId);
    ...
    void addCourseToClass(@Param("classId") Integer classId, @Param("courseId") Integer courseId);
}
